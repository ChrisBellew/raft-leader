...
const MIN_TIMEOUT_MILLISECONDS: u64 = 5000;
const MAX_ALIVE_DURATION_MILLISECONDS: u64 = 180_000;
const MAX_DEAD_DURATION_MILLISECONDS: u64 = 10_000;
const MIN_NETWORK_DELAY_MILLISECONDS: u64 = 10;
const MAX_NETWORK_DELAY_MILLISECONDS: u64 = 100;
    ...
    fn set_next_timeout(&mut self) {
        self.next_timeout = Instant::now()
            + Duration::from_millis(thread_rng().gen_range(
                MIN_TIMEOUT_MILLISECONDS..self.nodes.len() as u64 * 100 + MIN_TIMEOUT_MILLISECONDS,
            ));
    }
